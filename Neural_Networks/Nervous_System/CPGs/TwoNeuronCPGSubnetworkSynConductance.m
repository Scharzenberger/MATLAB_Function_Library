function gsyn_max = TwoNeuronCPGSubnetworkSynConductance(delta, dEsyn, Am, Sm, dEm, Ah, Sh, dEh, dEna, Gna)
...
gsyn_max = (-delta*(10^(-6)) - delta*Gna*minf*hinf + Gna*minf*hinf*dEna)/(delta - dEsyn);           % Equation straight from Szczecinski's CPG example.
